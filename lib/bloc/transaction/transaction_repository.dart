...
abstract class TransactionRepository {
  ...
  Future<DAOTransaction> signDAO(
      DAOTransaction tx, String applicationUser, String privKey);
  Future<String> send(String apiNode, Transaction tx);
  Future<String> sendDAO(String apiNode, DAOTransaction tx);
}
...
class TransactionRepositoryImpl implements TransactionRepository {
  ...
  Future<DAOTransaction> signDAO(
      DAOTransaction tx, String applicationUser, String privKey) async {
    var ec = getS256();

    DAOTransaction txNew = DAOTransaction(type: tx.type, data: tx.data);
