...
class UploadFormDesktop extends StatefulWidget {
  ...
  @override
  _UploadFormDesktopState createState() => _UploadFormDesktopState(uploadData);
}

class _UploadFormDesktopState extends State<UploadFormDesktop> {
  _UploadFormDesktopState(this.stateUploadData);
