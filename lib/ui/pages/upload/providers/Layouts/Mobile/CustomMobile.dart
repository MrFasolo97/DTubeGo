...
class CustomWizardMobile extends StatefulWidget {
  CustomWizardMobile(
  ...
  @override
  _CustomWizardMobileState createState() => _CustomWizardMobileState();
}

class _CustomWizardMobileState extends State<CustomWizardMobile> {
