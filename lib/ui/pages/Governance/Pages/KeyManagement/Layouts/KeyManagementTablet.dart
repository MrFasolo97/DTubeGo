import 'package:ovh.fso.dtubego/ui/pages/Governance/Pages/KeyManagement/Widgets/newKeyDialogDesktop.dart';
...
class KeyManagementTablet extends StatefulWidget {
  const KeyManagementTablet({
    Key? key,
  }) : super(key: key);

  @override
  _KeyManagementTabletState createState() => _KeyManagementTabletState();
}

class _KeyManagementTabletState extends State<KeyManagementTablet>
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 10),
                        child: Container(
                            width: 250, child: Text(user.keys[pos].pub)),
                      ),
                    ],
                  ),
                ),
