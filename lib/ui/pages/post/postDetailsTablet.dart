...
class PostDetailPageTablet extends StatefulWidget {
  ...
  @override
  _PostDetailPageTabletState createState() => _PostDetailPageTabletState();
}

class _PostDetailPageTabletState extends State<PostDetailPageTablet> {
  int reloadCount = 0;
  bool flagged = false;
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: [
                            //player /thumbnail - Updated YouTube player section
                            widget.post.videoSource == "youtube"
                              ...
                              onReady: () {
                                // Auto-play if needed based on directFocus
                                if (widget.directFocus != "none") {
                                  _controller.play();
                                }
                              },
                            )
