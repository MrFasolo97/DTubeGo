...
class VotesOverviewMobile extends StatefulWidget {
  VotesOverviewMobile({
    Key? key,
    required this.post,
  }) : super(key: key);
  ...
  @override
  _VotesOverviewMobileState createState() => _VotesOverviewMobileState();
}

class _VotesOverviewMobileState extends State<VotesOverviewMobile> {
