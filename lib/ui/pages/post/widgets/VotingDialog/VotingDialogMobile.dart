...
class VotingDialogMobile extends StatefulWidget {
  VotingDialogMobile(
      {Key? key,
  ...
  @override
  _VotingDialogMobileState createState() => _VotingDialogMobileState();
}

class _VotingDialogMobileState extends State<VotingDialogMobile> {
