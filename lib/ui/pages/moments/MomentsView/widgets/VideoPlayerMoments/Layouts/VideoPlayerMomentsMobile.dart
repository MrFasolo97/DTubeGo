...
class VideoPlayerMomentsMobile extends StatefulWidget {
  //final String link;
  ...
  @override
  _VideoPlayerMomentsMobileState createState() =>
      _VideoPlayerMomentsMobileState();
}

class _VideoPlayerMomentsMobileState extends State<VideoPlayerMomentsMobile> {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.contentUri(Uri.parse(widget.feedItem.videoUrl))
      ..initialize().then((_) {
