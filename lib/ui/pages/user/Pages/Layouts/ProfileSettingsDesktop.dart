...
import 'package:ovh.fso.dtubego/ui/pages/user/Widgets/ConnectYTChannelDialog.dart';
...
class ProfileSettingsDesktop extends StatefulWidget {
  ProfileSettingsDesktop({Key? key, required this.userBloc}) : super(key: key);
  final UserBloc userBloc;

  @override
  _ProfileSettingsDesktopState createState() => _ProfileSettingsDesktopState();
}

class _ProfileSettingsDesktopState extends State<ProfileSettingsDesktop>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: dtubeSubAppBarDesktop(true, "Profile Settings", context, []),
