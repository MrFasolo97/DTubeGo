...
class AboutDialogMobile extends StatefulWidget {
  const AboutDialogMobile({
    Key? key,
  }) : super(key: key);

  @override
  State<AboutDialogMobile> createState() => _AboutDialogMobileState();
}

class _AboutDialogMobileState extends State<AboutDialogMobile> {
