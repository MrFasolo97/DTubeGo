...
class _LoginFormState extends State<LoginForm> {
  ...
  void loggedInCallback(String socialUId, String socialProvider) {
    setState(() {
      _uid = socialUId;
    });
    var fullProviders = [
      BlocProvider<ThirdPartyLoginBloc>(
          create: (context) =>
              ThirdPartyLoginBloc(repository: ThirdPartyLoginRepositoryImpl())
                ..add(TryThirdPartyLoginEvent(
                    socialUId: socialUId, socialProvider: socialProvider))),
      BlocProvider<AvalonConfigBloc>(
          create: (context) =>
              AvalonConfigBloc(repository: AvalonConfigRepositoryImpl())),
