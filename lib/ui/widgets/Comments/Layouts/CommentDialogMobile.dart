...
class CommentDialogMobile extends StatefulWidget {
  CommentDialogMobile(
      {Key? key,
  ...
  @override
  _CommentDialogMobileState createState() => _CommentDialogMobileState();
}

class _CommentDialogMobileState extends State<CommentDialogMobile> {
